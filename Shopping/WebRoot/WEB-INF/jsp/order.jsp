...
<body>
	...
	<div class="container cart">
		...
		<div class="span24">
			...
			<!--  -->
			<form id="orderForm" action="${pageContext.request.contextPath}/pay_PayOrder.action" method="post">
				...
				<div class="span24">
					...
					<p>
						选择银行：<br/>
						<input type="radio" name="bank" value="ICBC-NET-B2C" checked="checked"/>工商银行
						<img src="${ pageContext.request.contextPath }/bank_img/icbc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="BOC-NET-B2C"/>中国银行
						<img src="${ pageContext.request.contextPath }/bank_img/bc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="ABC-NET-B2C"/>农业银行
						<img src="${ pageContext.request.contextPath }/bank_img/abc.bmp" align="middle"/>
						<br/>
						<input type="radio" name="bank" value="CMBC-NET-B2C"/>民生银行
						<img src="${ pageContext.request.contextPath }/bank_img/cmbc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="BOCO-NET-B2C"/>交通银行
						<img src="${ pageContext.request.contextPath }/bank_img/bcc.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="PINGANBANK-NET"/>平安银行
						<img src="${ pageContext.request.contextPath }/bank_img/pingan.bmp" align="middle"/>
						<br/>
						<input type="radio" name="bank" value="CCB-NET-B2C"/>建设银行
						<img src="${ pageContext.request.contextPath }/bank_img/ccb.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="SHB-NET-B2C"/>上海银行
						<img src="${ pageContext.request.contextPath }/bank_img/sh.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="BCCB-NET-B2C"/>北京银行
						<img src="${ pageContext.request.contextPath }/bank_img/bj.bmp" align="middle"/>
						<br/>
						<input type="radio" name="bank" value="CEB-NET-B2C"/>光大银行
						<img src="${ pageContext.request.contextPath }/bank_img/guangda.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="CMBCHINA-NET-B2C"/>招商银行
						<img src="${ pageContext.request.contextPath }/bank_img/cmb.bmp" align="middle"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="bank" value="POST-NET-B2C"/>邮政银行
