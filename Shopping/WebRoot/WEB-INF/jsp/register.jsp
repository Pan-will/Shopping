...
function change(){
	...
	/*由于浏览器的缓存，所以需要加上时间戳 
		一定注意：时间戳要用time标明，否则验证码刷新会报内存溢出异常。————time=···
	*/
	codeImg.src = "${pageContext.request.contextPath}/checkImg.action?time="+new Date().getTime();
}
</script>
</head>
<body>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" novalidate="novalidate" action="user_register" method="post" onsubmit="return validateForm()">
						<table>
							<tbody>
								<tr>
									<th><span class="requiredField">*</span>用户名:</th>
									<td>
										<input type="text" id="username" name="username" class="text" maxlength="20" onblur="validateUsername()" />
								...
								<tr>
									...
									<td>
										<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off" onblur="validatePsw()" />
								...
								<tr>
									...
									<td>
										<input type="password" name="repassword" id="repsw" class="text" maxlength="20" autocomplete="off" onblur="validateRepsw()" />
								...
								<tr>
									...
									<td>
										<input type="text" id="email" name="email" class="text" maxlength="200" onblur="validateEmail()" />
								...
								<tr>
									<th>姓名:</th>
									<td>
										<input type="text" name="name" id="name" class="text" maxlength="200" onblur="validateName()" />
								...
								<tr>
									<th>联系电话:</th>
									<td>
										<input type="text" name="phone" id="phone" class="text" onblur="validatePhone()" />
								...
								<tr>
									<th>地址:</th>
									<td>
										<input type="text" name="address" id="address" class="text" maxlength="200" onblur="validateAddr()" />
								...
								<tr>
									...
									<td>
										<span class="fieldSet"> 
											...
											<img id="rightcode" src="${pageContext.request.contextPath}/checkImg.action" alt="点击换一张" onclick="change()" />
										</span>
